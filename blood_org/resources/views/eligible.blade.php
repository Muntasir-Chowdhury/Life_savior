            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <div class="about-img">
                            <img src="{{asset('assets/img/wbd-3.jpg')}}" alt="Image">
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6">
                        <div class="about-text">
                            ...
                            <p>
                            <ul class="unOrderList" style="list-style-type:disc;">
        ...
        <div class="about">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <div class="about-img">
                            <img src="{{asset('assets/img/abe.jpeg')}}" alt="Image">
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6">
                        <div class="about-text">
                        <h2>AB Elite Plasma Donation</h2>
                            <p>
                            <ul class="unOrderList" style="list-style-type:disc;">
        ...
        <div class="about">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <div class="about-img">
                            <img src="{{asset('assets/img/abe-2.jpg')}}" alt="Image">
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6">
                        <div class="about-text">
                        <h2>Platelet Donation</h2>
                            <p>
                            <ul class="unOrderList" style="list-style-type:disc;">
        ...
        <div class="service">
            <div class="container">
                <div class="section-header">
                    <p>Life Savior</p>
                    <h2>Provide Services Bangladesh</h2>
                </div>
                <div class="row">
        ...
        <div class="footer">
            ...
            <div class="container copyright">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p>Designed By <a href="https://www.facebook.com/muntasir.ahmed.98">Muntasir Ahmed </a> and  
                        <a href="https://www.facebook.com/sanjida.shammy.906">Sanjida Shammy </a>
                        </p>
                    </div>
                </div>
            </div>
