    ...
    <body class="antialiased">
        <div class="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="hero row align-items-center">
                        <div class="col-md-17">
                            ...
                            <p>Blood donation will cost you nothing but will save a life</p>
            ...
            <div class="service">
                <div class="container">
                    <div class="section-header">
                        ...
                        <p>Life Savior</p>
                        <h2>You don't have to be a doctor to save lives</h2>
                    </div>
                    <div class="row">
            ...
            <div class="feature">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="row align-items-center feature-item tem">
                                <div class="col-5">
                                    <img src="assets/img/volunteers2.jpeg" alt="Feature">
                                </div>
                                <div class="col-7">
                            ...
                            <div class="row align-items-center feature-item tem">
                                <div class="col-5">
                                    <img src="assets/img/bloodbank.jpg" alt="Feature">
                                </div>
                                <div class="col-7">
                                    <h3>Blood Bank</h3>
                                    <p>
                            ...
                            <div class="row align-items-center feature-item tem">
                                <div class="col-5">
                                    <img src="assets/img/bloodcamp.jpg" alt="Feature">
                                </div>
                                <div class="col-7">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="team-item">
                                ...
                                <div class="team-text">
                                    <h2>Muntasir Ahmed Chowdhury</h2>
                                    <h3>Founder</h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="{{asset('assets/img/shammy.jpg')}}" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2>Sanjida Rahman Shammy</h2>
                                    <h3>Founder</h3>
                                    <div class="team-social">
                                        <a class="social-tw" href=""><i class="fab fa-twitter"></i></a>
                                        <a class="social-fb" href=""><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="team-item">
                                <div class="team2-img">
                                    <img src="{{asset('assets/img/rt4.jpg')}}" alt="Team Image">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="team-item">
                                <div class="team2-img">
                                    <img src="{{asset('assets/img/rt3.png')}}" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2>Nasif Imtiaj</h2>
                                    <h3>Volunteer</h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="team-item">
                                <div class="team2-img">
                                    <img src="{{asset('assets/img/rt2.jpg')}}" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2>Nuha</h2>
                                    <h3>Volunteer</h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="team-item">
                                <div class="team2-img">
                                    <img src="{{asset('assets/img/rt8.jpg')}}" alt="Team Image">
            ...
            <div class="newsletter">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h2>Donating blood during the COVID-19 pandemic: Save lives and be safe Blood donation COVID-19</h2>                           
                        </div>
                        <div class="col-md-4">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-item">
                                <img src="assets/img/blood4.jpg" alt="Blog">
                                <h3>Blood Camp at Moulovibazar</h3>
                                <div class="meta">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-item">
                                <img src="assets/img/card1.jpg" alt="Blog">
                                <h3>Blood Camp at Sunamgonj</h3>
                                <div class="meta">
                                    <i class="fa fa-list-alt"></i>
                                    <a href="">Monday</a>
                                    <i class="fa fa-calendar-alt"></i>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-item">
                                <img src="assets/img/card3.jpg" alt="Blog">
                                <h3>Blood Camp at Beanibazar</h3>
                                <div class="meta">
                                    <i class="fa fa-list-alt"></i>
                                    <a href="">Tuesdat</a>
                                    <i class="fa fa-calendar-alt"></i>
                                    <p>8-january-21</p>                                </div>
                                <p>
            ...
            <div class="blog">
                <div class="container">
                    <div class="section-header">
                        <p>Our prestigious voluntary work on campaigns by the team</p>
                        <h2>CAMPAIGN GALLERY</h2>
                    </div>
                    

                    <div class="row">
                        <div class="col-4 contain">
                          <img src="assets/img/donor.jpg" class="img-fluid gallery image" alt="Sheep 2">
                        </div>
                        <div class="col-4 contain">
                            <img src="assets/img/donor2.jpg" class="img-fluid gallery image" alt="Sheep 2">
                          </div>
                          <div class="col-4 contain">
                            <img src="assets/img/donor3.jpg" class="img-fluid gallery image" alt="Sheep 2">
                          </div>
                    ...
                    <div class="row">
                        <div class="col-4 contain">
                          <img src="assets/img/mbd.jpg" class="img-fluid gallery image" alt="Sheep 2">
                        </div>
                        <div class="col-4 contain">
                            <img src="assets/img/mbd2.jpg" class="img-fluid gallery image" alt="Sheep 2">
                          </div>
                          <div class="col-4 contain">
                          <img src="assets/img/mbd3.jpg" class="img-fluid gallery image" alt="Sheep 2">
                        </div>
